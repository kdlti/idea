...
class IdeExpandsIcon extends StatefulWidget {
  /// Creates an [IdeExpandsIcon] with the given padding, and a callback that is
  /// triggered when the icon is pressed.
  const IdeExpandsIcon({
    super.key,
  ...
  @override
  State<IdeExpandsIcon> createState() => _IdeExpandsIconState();
}

class _IdeExpandsIconState extends State<IdeExpandsIcon> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(IdeExpandsIcon oldWidget) {
