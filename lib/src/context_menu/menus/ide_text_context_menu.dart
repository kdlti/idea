...
class IdeTextContextMenu extends StatefulWidget {
  const IdeTextContextMenu({super.key, required this.data, this.controller, this.obscuredText = false});
  final String data;
  final TextEditingController? controller;
  final bool obscuredText;

  @override
  _IdeTextContextMenuState createState() => _IdeTextContextMenuState();
}

class _IdeTextContextMenuState extends State<IdeTextContextMenu> with IdeContextMenuStateMixin {
  @override
