...
const _overlayOuterPadding = EdgeInsetsDirectional.only(bottom: 12, start: 12, end: 12);
const _defaultOverlayShadowOffset = Offset(0, 6);
const _defaultListItemPadding = EdgeInsets.symmetric(vertical: 12, horizontal: 16);
...
class _DropdownOverlayState<T> extends State<_DropdownOverlay<T>> {
  ...
  Widget hintBuilder(BuildContext context) {
    return widget.hintBuilder != null ? widget.hintBuilder!(context, widget.hintText) : defaultHintBuilder(context, widget.hintText);
  }
  ...
  Widget defaultListItemBuilder(BuildContext context, T result, bool isSelected, VoidCallback onItemSelect) {
    return Row(
      children: [
        Expanded(
          child: Text(
            ...
            child: Container(
              ...
              child: DecoratedBox(
                decoration: BoxDecoration(
                  color: decoration?.expandedFillColor ?? IdeDropdownDecoration._defaultFillColor,
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          decoration?.expandedSuffixIcon ?? _defaultOverlayIconUp,
                                        ],
                                      ),
                                    ),
                                  ),
