...
import '../models/cupertino_date_picker_options.dart';
import '../models/material_date_picker_options.dart';
import '../models/material_time_picker_options.dart';
...
Future<DateTime?> showAdaptiveDateTimePicker({
  ...
  final TargetPlatform platform = pickerPlatform?.toTargetPlatform(context) ?? Theme.of(context).platform;
...
Future<DateTime?> showMaterialDateTimePicker({
  ...
  if (mode == DateTimeFieldPickerMode.dateAndTime || mode == DateTimeFieldPickerMode.date) {
  ...
  if (mode == DateTimeFieldPickerMode.dateAndTime || mode == DateTimeFieldPickerMode.time) {
  ...
  return showDatePicker(
    ...
    builder: (BuildContext context, Widget? child) {
      return MediaQuery(
        ...
        child: materialDatePickerOptions.builder?.call(context, child) ?? child!,
      );
    },
    ...
    switchToCalendarEntryModeIcon: materialDatePickerOptions.switchToCalendarEntryModeIcon,
    switchToInputEntryModeIcon: materialDatePickerOptions.switchToInputEntryModeIcon,
